...
- Read time: 8.20 s
- Gap-fill/preparation time: 13.90 s
- CDTS compute time: 852.42 s
- GeoTIFF write time: 45.64 s
- End-to-end elapsed time: 921.09 s
- Throughput: 423.79 eligible pixels s⁻¹
- Output: `04_intermediate\pilot\EVI_Series_ID_EU_150-X047-Y018_2001_2025_BECK_W5_S25.tif`

## Annual-output validation

- Finite date values checked: 149,368,652
- Observed date range: 1-366 DOY
- Date bands outside their calendar-year range: 0
- Date bands containing non-integer DOY: 0
- LOS: minimum 0.97, median 119.91, maximum 769.31 days
- R2: minimum -17.161, median 0.944, maximum 1.000
- RMSE: minimum 0.0000, median 0.0348, maximum 0.3170 EVI
